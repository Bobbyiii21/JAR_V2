...
void usercontrol(void) {
  ...
  while (1) {
    ...
    if (Controller1.ButtonL1.pressing()){
      intakeMotor.spin(fwd, 400, rpm);
    }
    else if (Controller1.ButtonL2.pressing()){
      intakeMotor.spin(fwd, -600, rpm);
    }
    ...
    case 0:
      ...
      {
        cataMotor.spin(fwd, 100, percent);
      }
    ...
    case 2:
      ...
      else if (Distance.objectDistance(mm) < 125 || Distance.objectDistance(mm) > 130)
      {
        double error = 128 - Distance.objectDistance(mm);
